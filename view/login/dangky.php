    ...
    <main class="container">
        ...
        <div class="container d-flex justify-content-center">
            <div style="width: 50%; background-color: #FBA81F; margin:20px 0;" class="rounded-3">
                <form method="post" class="pb-2 bg-opacity-50 ">
                    <H3 class="text-center pt-3 text-light">Đăng kí</H3>
                    <div class="mb-3 pe-3 pt-3 ps-3">
                        <input type="text" class="form-control" id="FisrtNameInput" aria-describedby="emailHelp"
                            placeholder="Họ và tên" required name='account_name'>
                    </div>
                    <div class="mb-3 pe-3 pt-3 ps-3">
                    ...
                    <div class="pe-3 pt-3 ps-3 d-flex justify-content-center">
                        <button type="submit" class="btn" style="background-color: #F87537; color:#ffffff" name='dangkySubmit'>
                            Đăng kí
                        </button>
                    </div>
                </form>
